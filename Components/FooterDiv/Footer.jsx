...
const Footer = () => {
  return (
    <div
      className="footer p-[2.5rem] mb-4 bg-blueColor
    rounded-[10px] gap-8 grid grid-cols-5 m-auto items-center justify-center "
    >
      <div>
        ...
        <p className="text-white pb-[13px] opacity-70 loading-7 ">
          We always make ourseekers and companies find the best jobs and
      ...
      <div className="grid">
        ...
        <div>
          <small className="text-[14px] text-white">testEmail@gmail.com</small>
